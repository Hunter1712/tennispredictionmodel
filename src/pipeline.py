...
CACHE_PATH = "models/data_cache.pkl"
...
class TennisPredictionPipeline:
    ...
    def run(self) -> tuple[LGBMClassifier, dict[str, float | pd.DataFrame]]:
    ...
    def load_existing(self) -> LGBMClassifier:
...
def run_pipeline() -> tuple[LGBMClassifier, dict[str, float | pd.DataFrame]]:
